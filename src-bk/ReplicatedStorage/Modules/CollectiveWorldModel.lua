-- CollectiveWorldModel (ModuleScript)
-- Extracted from: Movement_System_By_LettuceDev/Put_in_Replicated_Storage/Modules/Zone/ZoneController/CollectiveWorldModel
